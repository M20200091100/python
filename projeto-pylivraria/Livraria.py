...
class Livraria:
    ...
    def salvar(self, widget):
        self.livro.insert(self.text_titulo.get_text(),
            self.text_genero.get_text(), float(self.text_preco.get_text()),
            self.text_autor.get_text(), int(self.text_qtde_paginas.get_text()))
    ...
    def cadastrar_livro(self):
        ...
        self.window.set_title("Livraria")
